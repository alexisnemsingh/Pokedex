...
// pokemonName = "bulbasaur" -> bulbasaur page

export default async function PokemonPage({ params } : { params: { pokemonName: string } }) {
    // Object destructuring: extracts the pokemonName property from the params object, gets value out of it
    const { pokemonName } = params;

    // Fetches the pokemon data from the PokeAPI
    const pokemonObject = await getPokemon(pokemonName);

    console.log(pokemonObject); // Testing
